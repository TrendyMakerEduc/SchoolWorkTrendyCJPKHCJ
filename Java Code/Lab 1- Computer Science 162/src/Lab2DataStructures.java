...
// The total Running time for this algorithm would be RunningTime = (n**4) + 7n + 5
...
public static void Test(){
    String algo1 = Long.toString(access1DList(100000));
    String algo2 = Long.toString(access2DList(100000));
    String algo3 = Long.toString(MakeBig2DList(100000));
    String algo4 = Long.toString(Diagonal2DListSearch(100000));
    String algo5 = Long.toString(Access3DElementList(100000));
    String algo6 = Long.toString(AIStateHalfOfTheTimeMovement(100000));
    ...
    try {
        ...
        FileWriter fWriter = new FileWriter(
                "C:\\Users\\danny\\AndroidStudioProjects\\demo.docx");
