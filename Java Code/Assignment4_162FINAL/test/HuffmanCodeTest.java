...
public class HuffmanCodeTest {
    ...
    class SimpleString {
        ...
        void encode_specificLetter_returnsLetterCode(String letter) {
            assertEquals( "10", classUnderTest.encode("a") );
        }

        @Test
        void encode_exampleString_returnsEncodedString() {
            assertEquals("10101010", classUnderTest.encode("aaaa"));
        }

        @Test
        void decode_encodedString_returnsOriginalString() {
            String s = classUnderTest.encode("aaaa");
            assertEquals("aaaa", classUnderTest.decode(s));
        }
    ...
    class WikiString {
        ...
        void encode_specificLetter_returnsLetterCode(String letter) {
            assertEquals( "0111", classUnderTest.encode("a") );
        }

        @Test
        void encode_exampleString_returnsEncodedString() {
            assertEquals("01110111011101110111", classUnderTest.encode("aaaaa"));
        }
